...
test_layer = [i for i in range(10)]
...
batch_size = 288
save_interval = 100
save_path = "./pytorch_checkpoints_1.1"
...
model_path = os.path.join(save_path, "decoder_step_1000.pth")  # Replace with the correct saved model name
    ...
    if TRAINING:
        ...
        for step in range(steps):
            ...
            if (step + 1) % save_interval == 0:
                torch.save(decoder.state_dict(), os.path.join(save_path, f"decoder_step_{step + 1}.pth"))
